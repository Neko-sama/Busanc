...
router.post('/', cpUpload, function (req, res) {
    ...
    var query1 =  "insert into Indice2 (Cliente, Fecha_ingreso, Creado_por, Estado) values ('" + ncliente+"', '"+fechai+"','" + req.session.correo.replace('"', '').replace('"', '') +"', 0) ; ";
    ...
    var query14 = "insert into Solicitud2 values (0, null,'" + nombre_vendedor + "', '" + fechai + "', '" + fecham + "', null ,'" + nproyecto + "', '" + ncliente + "', '" + area + "', '" + fechav + "', '" + esptec + "', '" + cod_cliente + "', null, '" + muefis_obs + "', '" + fot_obs + "', '" + plaadj_obs + "', '" + levmed_obs + "'); "
